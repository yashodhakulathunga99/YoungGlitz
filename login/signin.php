...
mysqli_select_db($link,"e_commerce");
        ...
        while($row=mysqli_fetch_array($res))
        {
              ...
              $_SESSION["admin"]=$row["uid"];
                ?>
                  <script type="text/javascript">
                    window.location="../admin/productmanagement.php";
                  </script>
                <?php
              }
              $count++;
    ...
    <div class="container py-5 h-100">
      <div class="row d-flex align-items-center justify-content-center h-100">
        <div class="col-md-8 col-lg-7 col-xl-6">
          <img src="signup.jpg" class="img-fluid" alt="Phone image" height="300px" width="600px">
        </div>
        <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
          <form action="" method="post" name="f1">
            ...
            <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
              <input type="submit" value="Sign in" name="login" class="btn btn-success text-light my-2 py-3" style="width:100% ; border-radius: 30px; font-weight:600;" />
            </div>

          </form><br>
          <p align="center">Not a registered user? <a href="register.php" class="text-success" style="font-weight:600;text-decoration:none;">Register Here</a></p>
        </div>
      </div>
    </div>
  </section>
